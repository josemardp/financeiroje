...
CREATE TYPE life_event_type AS ENUM (
  ...
  'data_ccb',           -- eventos da comunidade
...
INSERT INTO public.life_events (user_id, scope, event_type, title, event_date, recurs, reserve_amount) VALUES
  ('<user_id>', 'family',  'aniversario',       'Aniversário (exemplo)', '2026-01-15', 'yearly',  200),
  ('<user_id>', 'family',  'aniversario',       'Aniversário Esdra',   '2026-05-28', 'yearly',  300),
  ('<user_id>', 'private', 'vencimento_fixo',   'Dízimo comunidade',          '2026-05-05', 'monthly', null);
```
...
- [ ] Aniversários de filha e Esdra aparecem como contexto quando próximos a 30 dias
...
- **Colaboração familiar** — multi-usuário real, educação financeira filha, conselheiro espiritual-financeiro familiar
